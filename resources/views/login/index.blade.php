...
<head>
  ...
  <title> Welcome to Diocese of Sultanpet | {{ __('main.Login') }}</title>
...
<body class="hold-transition login-page body" style="background-color: rgb(50 83 130)
...
<div class="login-box">
    <div class="register-logo">
     ...
     <center><a href="{{url('/')}}" style="color: white
      ; font-weight: 700;
    font-family: serif;"><b>R.C.Latin Catholic Diocese Of Sultanpet</b>
