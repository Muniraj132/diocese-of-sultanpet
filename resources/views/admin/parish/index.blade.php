            ...
            <div class="container-fluid">
                <div class="row mb-2 ml-5">
                    <div class="col-sm-4">
                        ...
                        <button class="@if(Request::segment(2)=="parish") btn btn-danger @else btn btn-secondary @endif">{{ __('main.parishes') }}</button>
                    </div>
                    <div class="col-sm-4">
                        {{-- <h4 class="m-0 text-dark">{{ __('main.ourteam') }}</h4> --}}
                        <button class="@if(Request::segment(2)=="priest") btn btn-danger @else btn btn-secondary @endif"> {{ __('main.priests') }}</button>
                    </div>
                    <div class="col-sm-4">
                        {{-- <h4 class="m-0 text-dark">{{ __('main.ourteam') }}</h4> --}}
                        <button class="@if(Request::segment(2)=="religio") btn btn-danger @else btn btn-secondary @endif">{{ __('main.religious') }}</button>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
