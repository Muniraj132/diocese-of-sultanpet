...
class ParishController extends Controller
{
    ...
    { 
        try {
            ...
            return view('admin.parish.create',compact('categories','languages'));
        } catch (Throwable $th) {
            Log::create([
                'model' => 'TeamMember',
                'message' => 'Parish create page could not be loaded.',
                'th_message' => $th->getMessage(),
                'th_file' => $th->getFile(),
                'th_line' => $th->getLine(),
            ]);
    ...
    { 
        try {
            ...
            return view('admin.parish.edit',compact('categories','value'));
        } catch (Throwable $th) {
